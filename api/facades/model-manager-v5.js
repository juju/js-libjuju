  ...
  */
  changeModelCredential(args, callback) {
    return new Promise((resolve, reject) => {
      ...
      let params;
      // github.com/juju/juju/apiserver/params#ChangeModelCredentialsParams
      if (args) {
        params = {};
        params['model-credentials'] = [];
        args.modelCredentials = args.modelCredentials || [];
        for (let i = 0; i < args.modelCredentials.length; i++) {
          // github.com/juju/juju/apiserver/params#ChangeModelCredentialParams
          if (args.modelCredentials[i]) {
            params['model-credentials'][i] = {};
            params['model-credentials'][i]['model-tag'] = args.modelCredentials[i].modelTag;
            params['model-credentials'][i]['credential-tag'] = args.modelCredentials[i].credentialTag;
          }
        }
      }
...
if (wrappers.wrapModelManager) {
  ...
  ModelManagerV5 = wrappers.wrapModelManager(ModelManagerV5);
}

module.exports = ModelManagerV5;