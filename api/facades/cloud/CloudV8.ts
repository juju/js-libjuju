/**
  Juju Cloud version 8.

  NOTE: This file was generated using the Juju schema
  from Juju 4.0.12 at the git SHA 7a497bb.
...
export interface ModelConfigSchemaArgs {
  "provider-type": string;
}

export interface ModelConfigSchemaField {
  description?: string;
...
export interface ModelConfigSchemaResult {
  error?: Error;
  schema?: Record<string, ModelConfigSchemaField>;
}
...
class CloudV8 implements Facade {
  static NAME = "Cloud";
  static VERSION = 8;
  ...
  modelConfigSchema(
    params: ModelConfigSchemaArgs
  ): Promise<ModelConfigSchemaResult> {
    return new Promise((resolve, reject) => {
      const req: JujuRequest = {
        type: "Cloud",
        request: "ModelConfigSchema",
        version: 8,
        params: params,
      };
