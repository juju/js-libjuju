  ...
  */
  addUnits(args, callback) {
    return new Promise((resolve, reject) => {
      // Prepare request parameters.
      let params;
      // github.com/juju/juju/apiserver/params#AddApplicationUnitsV5
      if (args) {
        params = {};
  ...
  */
  deploy(args, callback) {
    return new Promise((resolve, reject) => {
      // Prepare request parameters.
      let params;
      // github.com/juju/juju/apiserver/params#ApplicationsDeployV5
      if (args) {
        params = {};
        params['applications'] = [];
        args.applications = args.applications || [];
        for (let i = 0; i < args.applications.length; i++) {
          // github.com/juju/juju/apiserver/params#ApplicationDeployV5
...
if (wrappers.wrapApplication) {
  ...
  ApplicationV5 = wrappers.wrapApplication(ApplicationV5);
}

module.exports = ApplicationV5;