...
/**
  ...
  @param [resolve] The optional promise resolve function.
  @param [reject] The optional promise reject function.
  @param [transform] The optional response transform function.
  @return The returned function takes two arguments (err, value).
